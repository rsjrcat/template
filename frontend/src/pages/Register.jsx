...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (result.success) {
      toast.success('Registration successful! Welcome to BMS Academy!');
      navigate('/dashboard');
    } else {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <Link to="/" className="flex items-center justify-center space-x-2 mb-8">
          ...
          <span className="text-2xl font-bold text-gray-900">BMS Academy</span>
        </Link>
            ...
            <div>
              <div className="flex items-center">
                ...
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                  I agree to the{' '}
                  <Link to="/terms" className="text-blue-600 hover:text-primary-500">
                    Terms and Conditions
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-blue-600 hover:text-primary-500">
                    Privacy Policy
                  </Link>
                </label>
              </div>
